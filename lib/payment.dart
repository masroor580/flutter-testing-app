...
//           children: [
//             // 🔹 Main Content Section (Always Expands)
//             Expanded(
//               child: Column(
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
...
//             ),
//             if (isDesktop)
//               SizedBox(width: 320, child: _rightSideCards(isMobile: false)),
//           ],
//         ),
//         if (!isDesktop) ...[
//           const SizedBox(height: 20),
//           SizedBox(width: double.infinity, child: _rightSideCards(isMobile: true)),
//         ],
//       ],
//     );
//   }
...
//                       columnWidths: {
//                         0: FlexColumnWidth(1),
//                         1: isDesktop ? FlexColumnWidth(2) : FlexColumnWidth(1.5),
//                         2: isDesktop ? FlexColumnWidth(2) : FlexColumnWidth(1.5),
//                         3: isDesktop ? FlexColumnWidth(2) : FlexColumnWidth(1.5),
//                         4: isDesktop ? FlexColumnWidth(2) : FlexColumnWidth(1.5),
//                       },
//                       children: [
//                         _buildTableRow(["ID", "Status", "Payment Method", "Date", "Amount"], isHeader: true),
//                         _buildTableRow(["001", "Success", "Credit Card", "20 Feb 2024", "\$50.00"]),
//                         _buildTableRow(["002", "Pending", "Transfer", "20 Feb 2024", "\$150.00"]),
//                         _buildTableRow(["003", "Failed", "Bank Transfer", "21 Feb 2024", "\$75.00"]),
//                       ],
//                     ),
//                   ),
//                 );
...
//               fontSize: isHeader ? 16 : 14, // Larger font for headers
//             ),
//           ),
//         );
//       }).toList(),
...
//   ];
//
//   Widget _rightSideCards({bool isMobile = false}) {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.center,
//       children: earningsData.map((data) {
//         return _buildEarningsCard(isMobile, data["title"]!, data["amount"]!);
//       }).toList(),
//     );
//   }
//
//   Widget _buildEarningsCard(bool isMobile, String title, String amount) {
